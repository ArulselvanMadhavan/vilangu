...
let ir_to_backend out_dir ir_file =
...
let compiler source_file out_dir =
  ...
  let ir_to_backend = (ir_to_backend out_dir) in
...
let compiler_t = Term.(const compiler $ source_file_t $ out_dir_t)
