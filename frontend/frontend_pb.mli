...
val encode_type_expr_p_ranked_type : Frontend_types.type_expr_p_ranked_type -> Pbrt.Encoder.t -> unit
...
val encode_expr_p_while_expr : Frontend_types.expr_p_while_expr -> Pbrt.Encoder.t -> unit
(** [encode_expr_p_while_expr v encoder] encodes [v] with the given [encoder] *)
...
val decode_type_expr_p_ranked_type : Pbrt.Decoder.t -> Frontend_types.type_expr_p_ranked_type
...
val decode_expr_p_while_expr : Pbrt.Decoder.t -> Frontend_types.expr_p_while_expr
(** [decode_expr_p_while_expr decoder] decodes a [expr_p_while_expr] value from [decoder] *)
