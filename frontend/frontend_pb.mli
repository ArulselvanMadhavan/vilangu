...
val encode_expr_p_null_lit : Frontend_types.expr_p_null_lit -> Pbrt.Encoder.t -> unit
(** [encode_expr_p_null_lit v encoder] encodes [v] with the given [encoder] *)
...
val encode_expr_p_method_call : Frontend_types.expr_p_method_call -> Pbrt.Encoder.t -> unit
...
val encode_stmt_p_return : Frontend_types.stmt_p_return -> Pbrt.Encoder.t -> unit
(** [encode_stmt_p_return v encoder] encodes [v] with the given [encoder] *)
...
val decode_expr_p_null_lit : Pbrt.Decoder.t -> Frontend_types.expr_p_null_lit
(** [decode_expr_p_null_lit decoder] decodes a [expr_p_null_lit] value from [decoder] *)
...
val decode_stmt_p_return : Pbrt.Decoder.t -> Frontend_types.stmt_p_return
(** [decode_stmt_p_return decoder] decodes a [stmt_p_return] value from [decoder] *)
