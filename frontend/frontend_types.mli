...
type expr_p_null_lit = { null_texpr : type_expr }
...
type stmt_p_return = { ret_expr : expr }
...
val default_var_p_simple : ?var_name:string -> unit -> var_p_simple

(** [default_type_expr_p_class ()] is the default value for type [type_expr_p_class] *)
val default_type_expr_p_class : ?name:string -> unit -> type_expr_p_class
...
val default_type_expr_p_pointer : ?data:type_expr -> unit -> type_expr_p_pointer

(** [default_expr_p_null_lit ()] is the default value for type [expr_p_null_lit] *)
val default_expr_p_null_lit : ?null_texpr:type_expr -> unit -> expr_p_null_lit
...
val default_expr_p_assign : ?lhs:var -> ?rhs:expr -> unit -> expr_p_assign

(** [default_identifier ()] is the default value for type [identifier] *)
val default_identifier : ?id:var -> unit -> identifier
...
val default_stmt_p_printf : ?format:string -> ?f_args:expr list -> unit -> stmt_p_printf
...
(** [default_stmt_p_return ()] is the default value for type [stmt_p_return] *)
val default_stmt_p_return : ?ret_expr:expr -> unit -> stmt_p_return
...
val default_stmt_p_block : ?stmt_list:stmt list -> unit -> stmt_p_block
...
val default_param : ?param_type:type_expr -> ?param_name:string -> unit -> param
