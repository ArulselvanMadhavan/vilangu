...
val pp_type_expr_p_pointer : Format.formatter -> Frontend_types.type_expr_p_pointer -> unit 
(** [pp_type_expr_p_pointer v] formats v *)

val pp_expr_p_null_lit : Format.formatter -> Frontend_types.expr_p_null_lit -> unit 
(** [pp_expr_p_null_lit v] formats v *)
...
val pp_expr_p_array_creation : Format.formatter -> Frontend_types.expr_p_array_creation -> unit 
...
val pp_expr_p_class_creation : Format.formatter -> Frontend_types.expr_p_class_creation -> unit 
...
val pp_stmt_p_return : Format.formatter -> Frontend_types.stmt_p_return -> unit 
(** [pp_stmt_p_return v] formats v *)
