...
let default_var_p_field_mutable () : var_p_field_mutable =
  { base_expr = Frontend_types.default_expr (); field_index = 0l }
;;
...
let default_expr_p_array_creation_mutable () : expr_p_array_creation_mutable =
  { creation_exprs = []; texpr = Frontend_types.default_type_expr () }
;;
...
and decode_var_p_field d =
  ...
  ({ Frontend_types.base_expr = v.base_expr; Frontend_types.field_index = v.field_index }
...
and decode_expr_p_array_creation d =
  ...
  ({ Frontend_types.creation_exprs = v.creation_exprs; Frontend_types.texpr = v.texpr }
